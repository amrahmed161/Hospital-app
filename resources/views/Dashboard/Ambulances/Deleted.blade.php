    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{trans('Ambulances.Delete ambulance data')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('Ambulance.destroy','test')}}" method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            <p class="h5 text-danger"> {{trans('Ambulances.Are you sure you want to delete the car data?')}}</p>
