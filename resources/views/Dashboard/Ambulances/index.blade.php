...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('Ambulances.Ambulance')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Ambulances.Ambulance')}} </span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
								...
								<div class="table-responsive">
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												<th>#</th>
												<th >{{trans('Ambulances.car number')}}</th>
												<th >{{trans('Ambulances.car model')}}</th>
												<th>{{trans('Ambulances.made year')}}</th>
												<th>{{trans('Ambulances.car type')}}</th>
												<th >{{trans('Ambulances.driver name')}}</th>
                                                <th >{{ trans('ambulances.Driving license number') }}</th>
                                                <th > {{trans('Ambulances.phone')}}</th>
                                                <th >{{trans('Ambulances.status')}} </th>
                                                <th >{{trans('Ambulances.note')}}</th>
