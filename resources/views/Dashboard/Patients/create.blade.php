...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{trans('patients.patient')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('patients.add patient')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('Patients.store')}}" method="post" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <label> {{trans('patients.patient')}}</label>
                        ...
                        <div class="col">
                            <label>{{trans('patients.Date birth')}}</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label> {{trans(('patients.Blood quarter'))}}</label>
                    ...
                    <div class="row">
                        <div class="col">
                            <button class="btn btn-success">{{trans('patients.Save Data')}}</button>
                        </div>
                    </div>
