									...
									<div class="card-sigin">
										...
										<div class="card-sigin">
											<div class="main-signup-header">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="sectionChooser">
                                                        ...
                                                        <option value="ray_employee">{{trans('Dashboard/login_trans.x-ray employee')}}</option>
                                                        <option value="laboratorie_employee">{{trans('Dashboard/login_trans.laboratory employee')}}</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="panel" id="ray_employee">
                                                <h2>{{trans('Dashboard/login_trans.x-ray employee')}}</h2>
                                            ...
                                            <div class="panel" id="laboratorie_employee">
                                                    <h2>  {{trans('Dashboard/login_trans.laboratory employee')}}</h2>
