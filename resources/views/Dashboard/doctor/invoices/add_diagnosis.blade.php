    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{trans('Doctors.Diagnosing a patient condition')}}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">{{trans('Doctors.Diagnosis')}}</label>
                    <textarea class="form-control" name="diagnosis" rows="6"></textarea>
                </div>

                <div class="form-group">
                    <label for="exampleFormControlTextarea1">{{trans('Doctors.pharmaceutical')}}</label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary">{{trans('Doctors.Save Data')}}</button>
            </div>
            </form>
        </div>
    </div>
