    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{trans('patients.Define patient review ')}}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">{{trans('patients.Diagnosis')}}</label>
                    <textarea class="form-control" name="diagnosis" rows="6"></textarea>
                </div>

                <div class="form-group">
                    <label for="exampleFormControlTextarea1">{{trans('patients.pharmaceutical')}}</label>
                    <textarea class="form-control" name="medicine" rows="6"></textarea>
                </div>


                <div class="form-group" style="position:relative;">
                    <label>{{trans('patients.Save Data')}}</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{{trans('patients.Close')}}</button>
                <button type="submit" class="btn btn-primary">{{trans('patients.Save Data')}}</button>
            </div>
            </form>
        </div>
    </div>
