                                ...
                                <div class=" tab-menu-heading">
                                    <div class="tabs-menu1">
                                        ...
                                        <ul class="nav panel-tabs main-nav-line">
                                            <li class="nav-item"><a href="#tab1" class="nav-link active" data-toggle="tab">{{trans('patients.Patient record')}}</a></li>
                                            <li class="nav-item"><a href="#tab2" class="nav-link" data-toggle="tab">{{trans('patients.X-rays')}}</a></li>
                                            <li class="nav-item"><a href="#tab3" class="nav-link" data-toggle="tab">{{trans('patients.Laboratory')}}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="tab-pane" id="tab2">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    <tr>
                                                        <th>#</th>
                                                        <th>{{trans('patients.Service name')}}</th>
                                                        <th>{{trans('patients.Doctor name')}}</th>
                                                        <th>{{trans('patients.name radiology employee')}}</th>
                                                        <th>{{trans('patients.Detection status')}}</th>
...
{{--                                                         <td>{{$patient_ray->employee->name ?? 'noEmployee'}}</td>--}}
                                                            ...
                                                            @if($patient_ray->case == 0)
                                                                <td class="text-danger">{{trans('patients.not complete')}}</td>
                                                            @else
                                                                <td class="text-success"> {{trans('patients. complete')}}</td>
                                                            @endif
